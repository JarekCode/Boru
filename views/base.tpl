...
/* Footer */
	...
	<body>
			...
			<header id="header">
				...
				<nav id="nav">
					<ul>
						...
						<li><a title = "View the current status of student labs" href="/viewLabs">Labs</a></li>
		...
		% import os
		% boruStatus = os.system("service boru status")
		% if(boruStatus != 0):
		<div id="boruDownBanner">
			Boru is currently down. You can schedule classes however they will not start now. They will start once Boru is back up.
		</div>
		% else:
		% pass
		% end
